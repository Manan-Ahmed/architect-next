...
//   return {
//     title: `${service.title} — Remote Services for USA & UAE Clients`,
...
//           </Reveal>
//           <Reveal delay={100}>
//             <Eyebrow>{service.serviceArea ?? 'Service'}</Eyebrow>
//           </Reveal>
//           <Reveal delay={150}>
...
//                 A clear, disciplined sequence — built for clients working with us across time zones.
//               </p>
//             </Reveal>
//           </div>
...
//                 <Reveal delay={100}>
//                   <h2 className="mt-5 font-display text-heading text-secondary">
//                     Licensed professionals. Not a call center.
//                   </h2>
//                 </Reveal>
//                 <Reveal delay={150}>
//                   <p className="mt-5 text-base leading-relaxed text-secondary/60 md:text-lg">
...
//               <div className="lg:col-span-7">
//                 <div className="grid grid-cols-1 gap-px bg-secondary/10 sm:grid-cols-2">
//                   {service.credentials.badges.map((badge, i) => (
//                     <Reveal key={badge.label} delay={(i % 4) * 80}>
//                       <div className="flex items-start gap-3 bg-primary p-6">
