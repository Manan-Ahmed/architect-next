...
// import { getBlogBySlug, getRelatedPosts, getAdjacentPosts } from '@/data/blog';
...
//         <h1 className="text-5xl font-black uppercase text-white mb-6">Article Not Found</h1>
...
//     <>
//       <article>
// <header className="relative h-[85vh] min-h-[700px] flex items-end overflow-hidden">          <div
...
//           <div className="relative z-10 container-content pb-12 md:pb-16">
//             <Link
//               href="/blog"
//               className="inline-flex items-center gap-2 text-sm text-secondary hover:text-accent hover:text-white transition-colors mb-6"
//             >
...
//                 <span className="text-caption text-secondary">{post.date}</span>
...
// <h1 className="mt-4 text-5xl lg:text-7xl font-black uppercase leading-tight text-white">                {post.title}
//               </h1>
...
//                     {post.author.name}
//                   </p>
//                   <p className="text-caption text-white/70">{post.author.role}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//         <p className="text-2xl leading-relaxed text-secondary font-medium italic">
//           {post.excerpt}
//         </p>
//       </div>
...
//             <p className="mt-2 text-accent uppercase tracking-[0.2em] text-sm">
//               {post.author.role}
//             </p>

//             <p className="mt-5 text-secondary leading-8 max-w-2xl">
//               {post.author.bio}
//             </p>
...
// </div>
//         {(prev || next) && (
//           <div className="py-24 bg-primary-200 border-y border-secondary/10">
//             <div className="container-content">
//                 <div className="mb-12">
...
//                {prev && (
//           <button
//             onClick={() => router.push(`/blog/${prev.slug}`)}
//             className="group border border-secondary/10 bg-primary p-8 text-left transition-all duration-500 hover:border-accent hover:-translate-y-2"
//           >
...
//             <h3 className="mt-6 text-2xl font-bold uppercase leading-snug text-white group-hover:text-accent transition-colors">
//               {prev.title}
//             </h3>

//             <div className="mt-8 flex items-center gap-2 text-accent font-semibold uppercase tracking-wider">
//               Read Article
...
//             className="group border border-secondary/10 bg-primary p-8 text-right transition-all duration-500 hover:border-accent hover:-translate-y-2"
//           >
...
//             <div className="mt-8 flex justify-end items-center gap-2 text-accent font-semibold uppercase tracking-wider">
//               Read Article
//               <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
//             </div>
//           </button>
